...
using VBMS.Client.Infrastructure.Authentication;
using VBMS.Client.Infrastructure.Managers;
using VBMS.Client.Infrastructure.Managers.Preferences;
...
using VBMS.Client.Infrastructure.Managers.ExtendedAttribute;
using VBMS.Domain.Entities.ExtendedAttributes;
using VBMS.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace VBMS.Client.Extensions
{
