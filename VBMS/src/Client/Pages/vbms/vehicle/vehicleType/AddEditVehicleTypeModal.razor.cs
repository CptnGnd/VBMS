...
{
    public partial class AddEditVehicleTypeModal
    {
        [Inject] private IVehicleTypeManager VehicleTypeManager { get; set; }

        [Parameter] public AddEditVehicleTypeCommand AddEditVehicleTypeModel { get; set; } = new();
        ...
        {
            var response = await VehicleTypeManager.SaveAsync(AddEditVehicleTypeModel);
