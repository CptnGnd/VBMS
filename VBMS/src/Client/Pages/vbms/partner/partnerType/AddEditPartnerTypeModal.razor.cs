...
{
    public partial class AddEditPartnerTypeModal
    {
        [Inject] private IPartnerTypeManager PartnerTypeManager { get; set; }

        [Parameter] public AddEditPartnerTypeCommand AddEditPartnerTypeModel { get; set; } = new();
        ...
        {
            var response = await PartnerTypeManager.SaveAsync(AddEditPartnerTypeModel);
