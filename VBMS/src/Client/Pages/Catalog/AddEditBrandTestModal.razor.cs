...
{
    public partial class AddEditBrandTestModal
    {
        [Inject] private IBrandTestManager BrandTestManager { get; set; }

        [Parameter] public AddEditBrandTestCommand AddEditBrandTestModel { get; set; } = new();
        ...
        {
            var response = await BrandTestManager.SaveAsync(AddEditBrandTestModel);
