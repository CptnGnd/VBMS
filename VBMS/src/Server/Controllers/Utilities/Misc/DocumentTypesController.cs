...
using VBMS.Application.Features.DocumentTypes.Commands.Delete;
using VBMS.Application.Features.DocumentTypes.Queries.Export;
...
namespace VBMS.Server.Controllers.Utilities.Misc
{
