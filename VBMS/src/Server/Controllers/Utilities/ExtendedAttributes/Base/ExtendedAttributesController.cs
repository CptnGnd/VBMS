...
using VBMS.Application.Features.ExtendedAttributes.Commands.Delete;
...
using VBMS.Application.Features.ExtendedAttributes.Queries.GetById;
using VBMS.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace VBMS.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
